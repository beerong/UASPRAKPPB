...
public class com_samuel_moviedb_model_ModelTVRealmProxy extends com.samuel.moviedb.model.ModelTV
    implements RealmObjectProxy, com_samuel_moviedb_model_ModelTVRealmProxyInterface {
    ...
    private ProxyState<com.samuel.moviedb.model.ModelTV> proxyState;

    com_samuel_moviedb_model_ModelTVRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.samuel.moviedb.model.ModelTV>(this);
    ...
    @SuppressWarnings("cast")
    public static com.samuel.moviedb.model.ModelTV createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.samuel.moviedb.model.ModelTV obj = realm.createObjectInternal(com.samuel.moviedb.model.ModelTV.class, true, excludeFields);

        final com_samuel_moviedb_model_ModelTVRealmProxyInterface objProxy = (com_samuel_moviedb_model_ModelTVRealmProxyInterface) obj;
        if (json.has("Id")) {
            if (json.isNull("Id")) {
    ...
    public static com.samuel.moviedb.model.ModelTV createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.samuel.moviedb.model.ModelTV obj = new com.samuel.moviedb.model.ModelTV();
        final com_samuel_moviedb_model_ModelTVRealmProxyInterface objProxy = (com_samuel_moviedb_model_ModelTVRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.samuel.moviedb.model.ModelTV copyOrUpdate(Realm realm, com.samuel.moviedb.model.ModelTV object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.samuel.moviedb.model.ModelTV) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.samuel.moviedb.model.ModelTV copy(Realm realm, com.samuel.moviedb.model.ModelTV newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.samuel.moviedb.model.ModelTV realmObject = realm.createObjectInternal(com.samuel.moviedb.model.ModelTV.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_samuel_moviedb_model_ModelTVRealmProxyInterface realmObjectSource = (com_samuel_moviedb_model_ModelTVRealmProxyInterface) newObject;
        com_samuel_moviedb_model_ModelTVRealmProxyInterface realmObjectCopy = (com_samuel_moviedb_model_ModelTVRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.samuel.moviedb.model.ModelTV object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.samuel.moviedb.model.ModelTV.class);
        long tableNativePtr = table.getNativePtr();
        ModelTVColumnInfo columnInfo = (ModelTVColumnInfo) realm.getSchema().getColumnInfo(com.samuel.moviedb.model.ModelTV.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.IdIndex, rowIndex, ((com_samuel_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$Id(), false);
        String realmGet$Name = ((com_samuel_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$Name();
        if (realmGet$Name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.NameIndex, rowIndex, realmGet$Name, false);
        }
        Table.nativeSetDouble(tableNativePtr, columnInfo.VoteAverageIndex, rowIndex, ((com_samuel_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$VoteAverage(), false);
        String realmGet$Overview = ((com_samuel_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$Overview();
        if (realmGet$Overview != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.OverviewIndex, rowIndex, realmGet$Overview, false);
        }
        String realmGet$ReleaseDate = ((com_samuel_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$ReleaseDate();
        ...
        String realmGet$PosterPath = ((com_samuel_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$PosterPath();
        ...
        String realmGet$BackdropPath = ((com_samuel_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$BackdropPath();
        ...
        String realmGet$Popularity = ((com_samuel_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$Popularity();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ModelTVColumnInfo columnInfo = (ModelTVColumnInfo) realm.getSchema().getColumnInfo(com.samuel.moviedb.model.ModelTV.class);
        com.samuel.moviedb.model.ModelTV object = null;
        while (objects.hasNext()) {
            object = (com.samuel.moviedb.model.ModelTV) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.samuel.moviedb.model.ModelTV object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.samuel.moviedb.model.ModelTV.class);
    ...
    public static com.samuel.moviedb.model.ModelTV createDetachedCopy(com.samuel.moviedb.model.ModelTV realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.samuel.moviedb.model.ModelTV unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.samuel.moviedb.model.ModelTV();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.samuel.moviedb.model.ModelTV) cachedObject.object;
            }
            unmanagedObject = (com.samuel.moviedb.model.ModelTV) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_samuel_moviedb_model_ModelTVRealmProxyInterface unmanagedCopy = (com_samuel_moviedb_model_ModelTVRealmProxyInterface) unmanagedObject;
        com_samuel_moviedb_model_ModelTVRealmProxyInterface realmSource = (com_samuel_moviedb_model_ModelTVRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_samuel_moviedb_model_ModelTVRealmProxy aModelTV = (com_samuel_moviedb_model_ModelTVRealmProxy)o;
